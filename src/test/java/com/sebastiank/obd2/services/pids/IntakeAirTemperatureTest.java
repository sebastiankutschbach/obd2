...
import com.sebastiank.obd2.services.pids.showcurrentdata.IntakeAirTemperature;
import com.sebastiank.obd2.utils.Unit;
import org.junit.Test;

public class IntakeAirTemperatureTest {
  private IntakeAirTemperature sut = new IntakeAirTemperature();

  @Test
  public void getPid() {
    assertEquals(0x0F, sut.getPid());
  }

  @Test
  public void getDescription() {
    assertEquals("Intake air temperature", sut.getDescription());
  }
