...
import com.sebastiank.obd2.services.pids.showcurrentdata.CalculatedEngineLoad;
import com.sebastiank.obd2.utils.Unit;
import org.junit.Test;

public class CalculatedEngineLoadTest {

  private CalculatedEngineLoad sut = new CalculatedEngineLoad();

  @Test
  public void getPid() {
    assertEquals(0x04, sut.getPid());
  }

  @Test
  public void getDescription() {
    assertEquals("Calculated engine load", sut.getDescription());
  }
